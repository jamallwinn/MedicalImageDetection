...
st.set_page_config(page_title="Medical Injury Detection", layout="centered", initial_sidebar_state="collapsed")
# Streamlit page setup
st.title(" Medical Injury Detection")
...
analyze_button = st.button("Analyse the injury", type="secondary")
...
if uploaded_file is not None and api_key and analyze_button:
    ...
    with st.spinner("Analysing the image ..."):
        ...
        prompt_text = (
            "You are a highly knowledgeable Medical and Biomedical scientific image analysis expert. "
